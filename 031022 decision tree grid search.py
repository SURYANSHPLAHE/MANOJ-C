...
# grid search
#hyper parameter= choosing the best value that matches
...
print('Training Accuracy: {:.3f}'.format(CV_rfc.score(X_train, y_train)))
print('Testing Accuracy: {:.3f}'.format(CV_rfc.score(X_test, y_test)))
print(CV_rfc.best_params_)
classifier1=RandomForestClassifier(criterion='gini',n_estimators=100 ,
                           max_depth=3,min_samples_leaf=5,random_state=10)
